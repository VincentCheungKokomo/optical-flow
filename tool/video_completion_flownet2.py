...
def initialize_FlowNet2(args):
    """Initializes the FlowNet2 model.
    """
    model = torch.nn.DataParallel(FlowNet2(args))
...
def video_completion(args):
    ...
    # Flow model.
    FlowNet2_model = initialize_FlowNet2(args)
    ...
    corrFlowF = calculate_flow(args, FlowNet2_model, video, 'forward')
    corrFlowB = calculate_flow(args, FlowNet2_model, video, 'backward')
...
if __name__ == '__main__':
    ...
    # RAFT
    parser.add_argument('--model', default='./weight/FlowNet2_checkpoint.pth.tar', help="restore checkpoint")
